...
class ExtensionUpdater {
  ...
  scheduleChecks() {
    ...
    }, GITHUB_UPDATE_CONFIG.checkInterval);

    console.log(`⏰ Verificações automáticas a cada ${GITHUB_UPDATE_CONFIG.checkInterval / (60 * 1000)} minutos`);
